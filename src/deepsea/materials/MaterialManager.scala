...
object MaterialManager{
  ...
  case class WeightControl(docNumber: String, docName: String, zoneNumber: String, zoneName: String, mount: Int, side: Int, weight: Double, x: Double, y: Double, z: Double, user: String, date: Long)
