...
import deepsea.materials.MaterialManager.{AddMaterialComplect, GetEquipments, GetMaterialComplects, GetMaterialNodes, GetMaterials, GetMaterialsCode, GetSFIs, GetWCDrawings, GetWCZones, GetWeightControl, InsertEquipment, RemoveMaterialComplect, RemoveWeightControl, SetWeightControl, UpdateMaterial, UpdateMaterialComplect, UpdateMaterialNode}
